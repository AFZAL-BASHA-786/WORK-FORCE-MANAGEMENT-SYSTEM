...
// Now you can use selectedValueRef in this file



const SkilledCatalogue: React.FC = () =>{
    ...
    console.log(`Afzal ${cityState.selectedCity}`);
    ...
    useEffect(()=>{
        if(categories.length>0){
            const categoryObj: CategoryView | undefined = categories.find(cateObj => cateObj.name === "Skilled");
            if(categoryObj){
    ...
    const filteredTheProductsfunction = (subsList : SubCategoryView[])=>{
        ...
        //  && item.city===cityState.selectedCity
        ...
        <>
            ...
            <Container fluid>
                <Row>
                    ...
                    <Col>
                        <LayoutHeading heading='Skilled Catalogue' color='text-success'/>    
                    </Col>
                </Row>
            </Container> 
...
export default SkilledCatalogue;