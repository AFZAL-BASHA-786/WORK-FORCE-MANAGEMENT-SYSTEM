...
const UnskilledCatalogue: React.FC = () =>{
    ...
    useEffect(()=>{
        if(categories.length>0){
            const categoryObj: CategoryView | undefined = categories.find(cateObj => cateObj.name === "Unskilled");
            if(categoryObj){
        ...
        <>
            ...
            <Container fluid>
                <Row>
                    ...
                    <Col>
                        <LayoutHeading heading='Unskilled Catalogue' color='text-success'/>    
                    </Col>
                </Row>
            </Container> 
                            ...
                            filteredTheProducts.map((product) => {
                                return (
                                    <Col xs={3} key={product._id} className='mb-3 text-center '  >
                                        <Card >
                                            <Card.Header className='Unskilled-products'>
...
export default UnskilledCatalogue;